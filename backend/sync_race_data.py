...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # If the input is purely digits, treat it as a round number (int).
        # FastF1 does fuzzy name-matching on strings, which can silently
        # resolve to the wrong race if given a numeric string like "2".
        race_arg = int(race_input) if race_input.isdigit() else race_input
